...
g.insere_aresta(1, 2, 7)
g.insere_aresta(1, 3, 8)
g.insere_aresta(1, 4, 2)
g.insere_aresta(2, 5, 6)
g.insere_aresta(3, 4, 10)
g.insere_aresta(3, 5, 9)
g.insere_aresta(3, 6, 12)
g.insere_aresta(4, 5, 6)
g.insere_aresta(4, 6, 11)
g.insere_aresta(5, 7, 2)
g.insere_aresta(6, 7, 4)
